...
public class EmployeeControllerTest {
	...
	@BeforeEach
	public void setUp() {
		employee = new Employee("1234", "Balaji", 30, "7373564262", "Senior Associate");
	}
	...
	public void givenEmployeesList_whenGetAllEmployees_thenReturnEmployeesList() throws Exception {
		// given - precondition or setup
		Employee employee1 = new Employee("1234", "Balaji", 30, "7373564262", "Senior Associate");
		Employee employee2 = new Employee("1235", "CK", 40, "9993564262", "Associate");
	...
	public void givenEmployeeWithUpdates_whenUpdatedEmployee_thenReturnEmployeeUpdated() throws JsonProcessingException, Exception {
		// given - precondition or setup
		Employee employeeForUpdate = new Employee("1234", "BalajiCK", 35, "7373564262", "Senior Associate");
	...
	public void givenInvalidEmployeeWithUpdates_whenUpdatedEmployee_thenThrowsResourceNotFoundException() throws JsonProcessingException, Exception {
		// given - precondition or setup
		Employee employeeForUpdate = new Employee("6565", "BalajiCK", 35, "8786876878", "Senior Associate");
